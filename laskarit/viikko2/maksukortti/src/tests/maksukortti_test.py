...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiivikseksi(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 2 euroa")
    
    def test_syo_edullisesti_onnistuu_kun_kortilla_rahaa_vain_edullisen_hinta(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        # Rahaa jäljellä 2.50
    ...
    def test_syo_maukkaasti_onnistuu_kun_kortilla_rahaa_vain_maukkaan_hinta(self):
        self.maukas_kortti = Maksukortti(4)
        self.maukas_kortti.syo_maukkaasti()
        self.assertEqual(str(self.maukas_kortti), "Kortilla on rahaa 0 euroa")
